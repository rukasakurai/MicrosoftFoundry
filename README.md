...
- Optional Foundry Guide feedback-loop sample: a prompt agent, OpenTelemetry user ratings, and aggregate GitHub issue automation
...
| **6** *(optional)* | [entra-agent-registry.md](docs/entra-agent-registry.md) | Register agents for visibility in Entra admin center |
| **7** *(optional)* | [agent-mcp-oauth.md](docs/agent-mcp-oauth.md) | Connect an agent to an OAuth-authenticated remote MCP server |
