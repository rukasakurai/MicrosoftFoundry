...
| **7** *(optional)* | [data-security-governance.md](docs/data-security-governance.md) | Understand what Foundry's "Data security and governance" pane governs (and what it doesn't) |
