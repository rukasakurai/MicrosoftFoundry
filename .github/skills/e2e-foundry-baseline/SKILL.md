...
| `docs/owasp-genai-risk-control-mapping/README.md` | docs-accuracy check (no provisioning flow): caveats, internal consistency with deep dives, table integrity, Known unknowns safety guidance | ~5s | ✅ verify this as working analysis: source/link freshness, internal consistency, and overclaim review — not proof that every risk assignment is objectively correct; Known unknowns must stay scoped to public/sanitized validation |
