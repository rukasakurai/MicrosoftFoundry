...
| 8 | Agent stable endpoint / channel publishing | stable endpoint available after creation; optional Microsoft 365/Teams publishing | endpoint check: seconds; channel publishing: portal-dependent | ⚠️ stable endpoint is part of the new agent object. Microsoft 365/Teams publishing uses the portal; no public publishing API is available |
...
| `docs/agent-creation.md` | flows 3, 4, 5, 6, 8 | ~28s | ✅ |
